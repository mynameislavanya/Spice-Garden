...
* The website showcases a restaurant layout with essential sections such as **Home, Menu, Gallery, About, and Contact**.

* The project focuses on basic front-end development concepts and user interaction using JavaScript.
...
* **Menu** – Displays food items categorized as:
  * Breakfast
  * Lunch
  * Dinner
* **Gallery** – Images of food and restaurant ambience
* **Contact** – Review submission form
